    ...
    <div class="section">
      <table border="1" align="center">
        <tr>
          ...
          <td><a href="portfolio.php?cat=4" style="text-decoration: none;">Action</a></td>
          <td><a href="portfolio.php?cat=5" style="text-decoration: none;">Romance</a></td>
          <td><a href="portfolio.php?cat=6" style="text-decoration: none;">Sci-Fi</a></td>
        </tr>
      </table>
    </div>
